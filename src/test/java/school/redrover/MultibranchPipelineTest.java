...
public class MultibranchPipelineTest extends BaseTest {
    ...
    public void testRenameMultibranchDropdownBreadcrumbs() {
        ...
        getWait2().until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='jenkins-dropdown']/a[@href='/job/" + MULTIBRANCH_PIPELINE_NEW_NAME + "/confirm-rename']"))).click();
